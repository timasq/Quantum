...
cnf = tf.placeholder(dtype=tf.float64)
device_name = "/gpu:0"
...
for i in range(500):
    ...
    sess.run(thermal_overlap(cnf_random_generator(20,100),20,2))
...
#     N=20 
#     cnf=cnf_random_generator(N,90)
#     print(thermal_overlap(cnf,N,3))
...
#         for 
#             cnf=cnf_random_generator(N,m)
#             overlap=sess.run(thermal_overlap(cnf,N,beta))
#             # clauses=m
#             # bits=N
#             with open("3_SAT_cooling_20.csv", "a") as fp:
#                 wr = csv.writer(fp, dialect='excel')
#                 wr.writerow([N,beta,m,overlap])